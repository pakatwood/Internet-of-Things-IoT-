...
int obstacle_status =B100000;
  ...
  if(rdiagonalscanval<distancelimit/0.76604){
    stop_Stop();
    alarm();
  ...
  if(numcycles>=LPT){ //Watch if something is around every LPT loops while moving forward 
    ...
    set_Motorspeed( SPEED,FAST_SPEED);
       delay(backtime);
         ...
         // New Addition.
        else if( obstacle_sign=="11100" || obstacle_sign=="01000" || obstacle_sign=="00010" || obstacle_sign=="00111" || obstacle_sign=="00011"  || obstacle_sign=="00101" || obstacle_sign=="00110" || obstacle_sign=="01010" || obstacle_sign=="11000"  || obstacle_sign=="10100"  || obstacle_sign=="01100" ||obstacle_sign=="00100"  ||obstacle_sign=="01000" || obstacle_sign=="11011"  ||    obstacle_sign=="11101"  ||  obstacle_sign=="11110"  || obstacle_sign=="01110"  ){
    Serial.println("hand back left");
    go_Back();
    set_Motorspeed( SPEED,FAST_SPEED);
    delay(backtime);
